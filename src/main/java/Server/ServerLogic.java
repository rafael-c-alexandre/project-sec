...
public class ServerLogic {
    ...
    public byte[][] generateObtainLocationReportResponse(String username, byte[] encryptedData, byte[] signature, boolean isHA) throws NoSuchCoordsException, InvalidSignatureException {
        ...
        Coords coords = null;
        try {
            UserReport report = obtainLocationReport(reportUsername, epoch);

            if (!report.isClosed())
                throw new NoSuchCoordsException();

            coords = report.getCoords();
    ...
    public void submitProof(String username, ByteString encryptedProof, ByteString signature) throws InvalidProofException, NoReportFoundException, AlreadyConfirmedReportException {
    ...
    public Proof verifyProof(byte[] proof, byte[] signature, String username) throws InvalidProofException, NoReportFoundException, AlreadyConfirmedReportException {
